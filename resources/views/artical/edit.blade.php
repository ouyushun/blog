...
@section('content')
    ...
    <div>
        <form action="{{url("admin/artical/update/$art->art_id")}}" method="post" enctype="multipart/form-data">
            <table class="add_tab">
                <tbody>
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <tr>
                        ...
                        <td>
                            <input type="text" size="20" class="lg" name="art_title" value="{{$art->art_title}}">
                            <p>栏目名称最多为20个字符</p>
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="auther" value="{{$art->auther}}">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="cate_id" class="require">
                            ...
                            <option value="{{$cate->cate_id}}" @if($cate->cate_id==$art->cate_id) selected ='selected' @endif  > {{$cate->cate_name}}</option>
                            @endforeach
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="art_desc" >{{$art->art_desc}}</textarea> 
                        <p>描述最多为50个字符</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" name="art_content" type="text/plain" style="width:860px;height:500px;">{!! $art->art_content !!}</script>
                        <script type="text/javascript">
